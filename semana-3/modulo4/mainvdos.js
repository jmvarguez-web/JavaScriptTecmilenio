...
class Libro {
  ...
  set autor(nuevoAutor) {
    this.propiedades._precio = nuevoAutor;
  }
  set precio(nuevoPrecio) {
    this.propiedades._precio = nuevoPrecio;
  }

  obtenerTodosLosDatos() {
    console.log(
      `Titulo: ${this.titulo}, Autor: ${this.autor}, Precio:${this.precio} `
    );
  }
}
